      ...
      <div class="som-fav-details">
        ...
        ${t.length>0?H`
          ...
          <ol class="som-fav-steps">
            ${t.map(e=>H`
              <li>
                ${"manual"===e.kind?e.text:ut("sommelier.brew_phase",{n:e.phaseIndex+1,total:e.phaseCount})}
              </li>
            `)}
          </ol>
        `:Z}
