...
`,sa=[{key:"show_header",defaultOn:!0},{key:"show_status",defaultOn:!0},{key:"show_profiles",defaultOn:!0},{key:"show_recipes",defaultOn:!0},{key:"show_freestyle",defaultOn:!1},{key:"show_sommelier",defaultOn:!1},{key:"show_stats",defaultOn:!1},{key:"show_maintenance",defaultOn:!1},{key:"show_settings",defaultOn:!1},{key:"compact",defaultOn:!1}];let oa=class extends ce{constructor(){super(...arguments),this._manualMode=!1}setConfig(e){this._config=e}_fireConfigChanged(){const e=new CustomEvent("config-changed",{detail:{config:{...this._config}},bubbles:!0,composed:!0});this.dispatchEvent(e)}_valueChanged(e,t){const i=t.target,a=i instanceof HTMLInputElement&&"checkbox"===i.type?i.checked:i.value;this._config={...this._config,[e]:a},this._fireConfigChanged()}_prefixChanged(e){const t=e.target.value;this._config={...this._config,entity_prefix:t.trim()},this._fireConfigChanged()}_deviceSelected(e){const t=e.target.value;if("__manual__"===t)return this._manualMode=!0,this._config={...this._config,entity_prefix:""},void this._fireConfigChanged();this._manualMode=!1;const i=(this.hass?na(this.hass):[]).find(e=>e.prefix===t);this._config={...this._config,entity_prefix:t,name:i?.name||this._config.name},this._fireConfigChanged()}render(){if(!this._config)return Z;Mt(this.hass);const e=this.hass?na(this.hass):[],t=this._config.entity_prefix||"",i=e.some(e=>e.prefix===t),a=this._manualMode||!!t&&!i,n=e.length>0&&a;return H`
    ...
    `}};function la(e){return Array.isArray(e)?e.filter(e=>"string"==typeof e&&e.trim().length>0):[]}function ca(e){const t=Array.isArray(e.machine_phases)?e.machine_phases:[],i=function(e){return e?Array.isArray(e)?{pre:e.filter(e=>"string"==typeof e)}:e:{}}(e.steps),a=[];for(const e of la(i.pre))a.push({kind:"manual",text:e});const n=t.length;t.forEach((e,t)=>{for(const t of la(e?.user_action_before))a.push({kind:"manual",text:t});const i=e&&"object"==typeof e.component&&null!==e.component?e.component:void 0;a.push({kind:"brew",phaseIndex:t,phaseCount:n,component:i})});for(const e of la(i.post))a.push({kind:"manual",text:e});return a}function da(e){const t=ca(e),i=t.filter(e=>"brew"===e.kind).length;return i>1||t.some(e=>"manual"===e.kind)}e([fe({attribute:!1})],oa.prototype,"hass",void 0),e([_e()],oa.prototype,"_config",void 0),e([_e()],oa.prototype,"_manualMode",void 0),oa=e([pe("melitta-barista-card-editor")],oa);const pa=["no_llm_agent","no_llm_agent_selected","llm_agent_missing"];function ma(e){const t=e?.code;return"string"==typeof t?t:null}function ua(e){const t=ma(e);if(null===t)return null;const i=Ft(`sommelier.error.${t}`);if(void 0!==i)return i;const a=function(e){const t=ma(e);return null===t?null:pa.includes(t)?`sommelier.err.${t}`:null}(e);return null===a?null:Ct(a)}const fa={"sommelier.wizard_title":"wizard.title","sommelier.step_of":"wizard.step_of","sommelier.done":"wizard.step.done","sommelier.finish":"wizard.finish.button"},_a={m:"total",total:"m"};function ga(e,t){const i=fa[e];if(void 0!==i){const e=Ft(i);if(void 0!==e)return t?function(e,t){return e.replace(/\{(\w+)\}/g,(e,i)=>{const a=t[i];if(void 0!==a)return String(a);const n=_a[i],r=void 0===n?void 0:t[n];return void 0===r?e:String(r)})}(e,t):e}return Ct(e,t)}function ha(e){const t=ga("sommelier.brew_phase",{n:e.phaseIndex+1,total:e.phaseCount}),i=function(e){if("brew"!==e.kind||!e.component)return{process:null,portionMl:null,intensity:null};const t=e.component,i="string"==typeof t.process&&"none"!==t.process?t.process:null,a=t.portion_ml;return{process:i,portionMl:"number"==typeof a&&Number.isFinite(a)&&a>0?a:null,intensity:"coffee"===i&&"string"==typeof t.intensity?t.intensity:null}}(e),a=[];return i.process&&a.push(Kt("process",i.process)),null!==i.portionMl&&a.push(Ct("freestyle.portion_value",{value:i.portionMl})),i.intensity&&a.push(Kt("intensity",i.intensity)),a.length?`${t} — ${a.join(", ")}`:t}let va=class extends ce{constructor(){super(...arguments),this._favorites=[],this._hoppers={hopper1:null,hopper2:null},this._loaded=!1,this._error=!1,this._generating=!1,this._quickRecipe=null,this._wizard=null,this._infoFavId=null,this._loading=!1}willUpdate(e){Mt(this.hass),!this.hass||this._loaded||this._loading||this._error||this._loadData()}async _loadData(){this._loading=!0;try{const[t,i]=await Promise.all([ia(this.hass),(e=this.hass,e.callWS({type:ta.hoppersGet}))]);this._favorites=t.slice(0,3),this._hoppers=i,this._loaded=!0}catch(e){console.warn("[melitta-card] Sommelier not available:",e),this._error=!0}finally{this._loading=!1}var e}_retry(){this._error=!1}_notify(e){this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:e},bubbles:!0,composed:!0}))}async _surpriseMe(){if(this.hass&&!this._generating){this._generating=!0,this._quickRecipe=null;try{this._quickRecipe=await async function(e){return(await e.callWS({type:ta.generate,mode:"surprise_me",count:1})).session.recipes[0]??null}(this.hass)}catch(e){console.error("[melitta-card] Generate failed:",e),this._notify(ua(e)??Ct("sommelier.error_generate"))}finally{this._generating=!1}}}async _brewRecipe(e){var t,i;if(this.hass)if(da(e))this._openWizard(e.name,{recipeId:e.id},e);else try{await(t=this.hass,i=e.id,t.callWS({type:ta.brew,recipe_id:i})),this._quickRecipe=null}catch(e){console.error("[melitta-card] Brew failed:",e),this._notify(Ct("sommelier.error_brew"))}}async _brewFavorite(e){var t,i;if(this.hass)if(da(e))this._openWizard(e.name,{favoriteId:e.id},e);else try{await(t=this.hass,i=e.id,t.callWS({type:ta.favoritesBrew,favorite_id:i})),this._favorites=this._favorites.map(t=>t.id===e.id?{...t,brew_count:(t.brew_count??0)+1}:t)}catch(e){console.error("[melitta-card] Brew favorite failed:",e),this._notify(Ct("sommelier.error_brew"))}}_openWizard(e,t,i){this._wizard={name:e,target:t,plan:ca(i),index:0,brewing:!1,phaseRunning:!1}}_wizardClose(e){const t=this._wizard;this._wizard=null,e&&t&&(t.target.favoriteId&&(this._favorites=this._favorites.map(e=>e.id===t.target.favoriteId?{...e,brew_count:(e.brew_count??0)+1}:e)),t.target.recipeId&&(this._quickRecipe=null))}_wizardAdvance(){const e=this._wizard;e&&(e.index+1>=e.plan.length?this._wizardClose(!0):this._wizard={...e,index:e.index+1,phaseRunning:!1})}async _wizardBrew(){const e=this._wizard;if(!e||!this.hass||e.brewing)return;const t=e.plan[e.index];if("brew"===t.kind){this._wizard={...e,brewing:!0};try{await(i=this.hass,a=e.target,n=t.phaseIndex,i.callWS({type:`${he}/sommelier/brew_phase`,...a.recipeId?{recipe_id:a.recipeId}:{},...a.favoriteId?{favorite_id:a.favoriteId}:{},phase_index:n})),e.index+1>=e.plan.length?this._wizardClose(!0):this._wizard={...e,brewing:!1,phaseRunning:!0}}catch(t){console.error("[melitta-card] Brew phase failed:",t),this._notify(Ct("sommelier.error_brew")),this._wizard={...e,brewing:!1}}var i,a,n}}render(){return H`
    ...
    `}_renderFavInfo(e){const t=ca(e);return H`
      <div class="som-fav-details">
        ...
        ${t.length>0?H`
          ...
          <ol class="som-fav-steps">
            ${t.map(e=>H`
              <li>${"manual"===e.kind?e.text:ha(e)}</li>
            `)}
          </ol>
        `:Z}
      </div>
    `}_renderWizard(e){const t=e.plan[e.index],i=e.plan.length;return H`
      ...
      <div class="som-wizard" role="dialog" aria-modal="true">
        <div class="som-wiz-head">
          <span class="som-wiz-title">${ga("sommelier.wizard_title")}</span>
          <span class="som-wiz-name">${e.name}</span>
        </div>
        <div class="som-wiz-progress">
          ${ga("sommelier.step_of",{n:e.index+1,total:i})}
        </div>
        <ol class="som-wiz-steps">
          ${e.plan.map((t,i)=>H`
            <li class=${i===e.index?"current":i<e.index?"done":""}>
              ${"manual"===t.kind?t.text:ha(t)}
            </li>
          `)}
        </ol>
        ${e.phaseRunning?H`
          <div class="som-wiz-note">${ga("sommelier.phase_running")}</div>
        `:Z}
        <div class="som-wiz-actions">
          ...
          ${"manual"===t.kind||e.phaseRunning?H`
            <button class="som-brew-btn" @click=${()=>this._wizardAdvance()}>
              ${e.index+1>=i?ga("sommelier.finish"):ga("sommelier.done")}
            </button>
          `:H`
            <button class="som-brew-btn" ?disabled=${e.brewing}
              ...
              ${ga("sommelier.brew_phase",{n:t.phaseIndex+1,total:t.phaseCount})}
            </button>
          `}
        </div>
      </div>
  ...
  `;var i}_renderRecipeIcon(e,t,i){const a=function(e,t,i){if(Array.isArray(t))for(const i of t)if(tt(i)&&i.name===e&&"icon"in i)return lt(i);if(i&&Array.isArray(i.recipes))for(const t of i.recipes)if(tt(t)&&t.name===e&&"icon"in t)return lt(t);return{found:!1,icon:null}}(e,this._recipeEntity()?.attributes?.recipes,this._contract);return a.found?function(e,t,i){const a=si(e,t);return null===a?li("",t,i):oi(a.frame,a.layers,a.steam,t,i)}(a.icon,t,i):li(e,t,i)}_renderFreestyle(){const e=ot(this._contract);return H`
    ...
    `}static get styles(){return ra}};e([fe({attribute:!1})],ba.prototype,"hass",void 0),e([_e()],ba.prototype,"_config",void 0),e([_e()],ba.prototype,"_resolvedPrefix",void 0),e([_e()],ba.prototype,"_fsName",void 0),e([_e()],ba.prototype,"_fsRecipe",void 0),e([_e()],ba.prototype,"_selectedDk",void 0),e([_e()],ba.prototype,"_twoCups",void 0),e([_e()],ba.prototype,"_editDk",void 0),e([_e()],ba.prototype,"_editState",void 0),e([_e()],ba.prototype,"_editSaving",void 0),e([_e()],ba.prototype,"_confirmKey",void 0),e([_e()],ba.prototype,"_busyKey",void 0),e([_e()],ba.prototype,"_contract",void 0),ba=e([pe("melitta-barista-card")],ba),window.customCards=window.customCards||[],window.customCards.some(e=>"melitta-barista-card"===e.type)||window.customCards.push({type:"melitta-barista-card",name:"Melitta Barista Card",description:"Premium control card for Melitta Barista coffee machines",preview:!0,documentationURL:"https://github.com/dzerik/melitta-barista-card"}),console.info(`%c MELITTA-BARISTA-CARD %c v${ge} `,"color: white; background: #795548; font-weight: bold; padding: 2px 6px; border-radius: 3px 0 0 3px;","color: #795548; background: #efebe9; font-weight: bold; padding: 2px 6px; border-radius: 0 3px 3px 0;");export{ba as MelittaBaristaCard};
